...
const CurriculumAsyncSelect: React.FC<CurriculumAsyncSelectProps> = ({ setFieldTouched, setFieldValue, onChange, touched, error }) => {
  ...
  const data = useMemo(() => {
    return currentPageCurriculum.map((level: ILevel) => ({
      key: level._id,
