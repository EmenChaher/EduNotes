...
abstract class ApiResponse {
  constructor(protected statusCode: ResponseStatus, protected status: ResponseStatus, protected message: string) {}
...
export class EndpointNotFoundResponse extends ApiResponse {
  ...
  send(res: Response): Response {
    ...
    return super.prepare<EndpointNotFoundResponse>(res, this);
  }
}
